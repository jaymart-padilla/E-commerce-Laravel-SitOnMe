...
export default function Breadcrumbs({ label, className = "" }) {
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div className="flex items-center">
                        ...
                        <a
                            href={paths.shop.url}
                            className="inline-flex items-center ml-1 md:ml-2 text-sm font-medium text-gray-400 hover:text-white capitalize"
                        >
                ...
                <li aria-current="page">
                    <div className="flex items-center">
                        ...
                        <span className="ml-1 text-sm font-medium md:ml-2 text-gray-400 capitalize">
                            <i
                                className={`fa-solid fa-truck-ramp-box mr-2 ${COLOR}`}
                            ></i>
                            {label}
                        </span>
                    </div>
